...
SPARK_HOME=/opt/spark2.4.5/spark-2.4.5-bin-hadoop2.7 
...
# export PYTHONPATH
PYTHONPATH=/home/harry/anaconda3
PYSPARK_PYTHON=/home/harry/anaconda3
export PATH=$PYTHONPATH/bin:$PATH
export PYSPARK_PYTHON=$PYTHONPATH/bin:$PATH
